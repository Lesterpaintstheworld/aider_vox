...
from aider_vox.utils import ChdirTemporaryDirectory, GitTemporaryDirectory, make_repo
...
class TestCommands(TestCase):
    ...
    def test_cmd_add_bad_glob(self):
        # https://github.com/paul-gauthier/aider_vox/issues/293
    ...
    def test_cmd_add_from_subdir_again(self):
        with GitTemporaryDirectory():
            ...
            # https://github.com/paul-gauthier/aider_vox/issues/201
    ...
    def test_cmd_add_from_outside_root(self):
        with ChdirTemporaryDirectory() as tmp_dname:
            ...
            # https://github.com/paul-gauthier/aider_vox/issues/178
    ...
    def test_cmd_undo_with_dirty_files_not_in_last_commit(self):
        with GitTemporaryDirectory() as repo_dir:
            ...
            coder.aider_vox_commit_hashes.add(last_commit_hash)
    ...
    def test_cmd_add_aider_voxignored_file(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
            ...
            repo = GitRepo(
                ...
                fnames,
                None,
                aider_vox_ignore_file=str(aignore),
            )
    ...
    def test_cmd_ask(self):
        ...
        with mock.patch("aider_vox.coders.Coder.run") as mock_run:
