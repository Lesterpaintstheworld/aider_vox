...
from aider_vox.io import AutoCompleter, InputOutput
from aider_vox.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    @patch("aider_vox.io.PromptSession")
    def test_get_input_is_a_directory_error(self, MockPromptSession):
        ...
        with patch("aider_vox.io.open", side_effect=IsADirectoryError):
