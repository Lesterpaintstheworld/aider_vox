...
[aider_vox's code editing leaderboard](https://aider_vox.chat/docs/leaderboards/)
...
You can code with all of these models using aider_vox like this:
...
$ aider_vox --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ aider_vox --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ aider_vox --model openrouter/meta-llama/llama-3.1-405b-instruct
$ aider_vox --model openrouter/meta-llama/llama-3.1-70b-instruct
$ aider_vox --model openrouter/meta-llama/llama-3.1-8b-instruct
```
...
secured #7 on aider_vox's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on aider_vox's code editing
benchmark. 
